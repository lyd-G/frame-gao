...
public class ConvertUtil {
    ...
    public static Number toNum(Object obj) {
        ...
        try {
            ...
            throw new GlobalErrorException(FrameMessageEnum.EFRA0010);
        }
    }
