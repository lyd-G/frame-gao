...
public class AuthTokenErrorException extends BaseErrorException {
    ...
    public AuthTokenErrorException(IMessageEnum messageEnum, Object[] args) {
    ...
    public AuthTokenErrorException(IMessageEnum messageEnum) {
