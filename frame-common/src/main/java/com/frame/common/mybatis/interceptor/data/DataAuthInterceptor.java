package com.frame.common.mybatis.interceptor.data;
...
import com.frame.common.mybatis.annotation.DataAuth;
import com.frame.common.mybatis.service.IDataAuthService;
import com.frame.common.mybatis.util.DataAuthUtils;
...
public class DataAuthInterceptor extends AbstractSqlParserHandler implements Interceptor {
    ...
    private String getAuthSql(String dataAuth) {
        // 获取登录id
        String staffId = ShiroUser.getCurrentUser().getAuthId();
        // 获取数据权限sql数据
